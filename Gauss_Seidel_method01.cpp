...
array <long double, 3> gauss_seidel_method(array <array <long double, 4>, 3> &adMat) {
    ...
    if(invalid) {
        throw runtime_error("Matrix cannot be made diagonally dominant for Gauss-Seidel method.");
    }
...
int main() {
    ...
    try {
        array <long double, 3> ans = gauss_seidel_method(adMat);
